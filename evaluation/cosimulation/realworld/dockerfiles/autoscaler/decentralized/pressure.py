...
from evaluation.cosimulation.orchestration.model import PressureAutoscalerConfiguration
...
def read_initial_configuration() -> PressureAutoscalerConfiguration:
    ...
    with open(config_file_path, 'r') as f:
        config = json.load(f)
        config = PressureAutoscalerConfiguration.from_json(config)
        return config
